...
if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'Club21');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Club21 Invoice');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "فاتورة ترابيزو");
}
