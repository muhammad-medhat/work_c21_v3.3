...
class TCPDF {
	 ...
	 */
	public function __construct($orientation='P', $unit='mm', $format='A5', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
   ...
   * @param $border (mixed) Indicates if borders must be drawn around the cell. The value can be a number:
      ...
      *   <li>1: frame</li>
      * </ul> or a string containing some or all of the following characters (in any order):
      * <ul>
      *   <li>L: left</li>
      *   <li>T: top</li>
      *   <li>R: right</li>
      *   <li>B: bottom</li>
      * </ul> or an array of line styles for each border group - for example: array('LTRB' => array('width' => 2, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)))
   * @param $ln (int) Indicates where the current position should go after the call. Possible values are:
      * <ul>
      *  <li>0: to the right (or left for RTL languages)</li>
      *  <li>1: to the beginning of the next line</li>
      *  <li>2: below</li>
      * </ul> Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
   ...
   *    <ul>
   *      <li>0 = disabled</li>
   *      <li>1 = horizontal scaling only if text is larger than cell width</li>
   *      <li>2 = forced horizontal scaling to fit cell width</li>
   *      <li>3 = character spacing only if text is larger than cell width</li>
   *      <li>4 = forced character spacing to fit cell width</li>
   *    </ul> General font stretching and scaling values will be preserved when possible.
	 * @param $ignore_min_height (boolean) if true ignore automatic minimum height value.
   ...
   *</ul> or a string containing some or all of the following characters (in any order):
    <ul>
      ...
      <li>R: right</li>
      <li>B: bottom</li>
      </ul> or an array of line styles for each border group 
      - for example: 
      array('LTRB' => array('width' => 2, 
        'cap' => 'butt', 
        'join' => 'miter', 
        'dash' => 0, 
        'color' => array(0, 0, 0)))
        ...
        *   <li>C: center</li><li>R: right align</li>
        *   <li>J: justification (default value when $ishtml=false)</li>
        * </ul>
	 * @param $fill (boolean) Indicates if the cell background must be painted (true) or transparent (false).
