...
<td>
-->
      <div id='order_details_container' class='fr' style='margin:1% 0 0 25%;overflow-y:scroll'>
        <?php $this->load->view($subdir .'/order_details_table')?>
      </div>
<!--
</td>
<td>-->
      <div id='order_summery' class='fl' style='margin:1% 0 0 25%;border:solid 1px;border-radius:5px;padding-right: 1em;'>
