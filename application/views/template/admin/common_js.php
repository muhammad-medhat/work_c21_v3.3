  <link rel="stylesheet" href="<?= base_url()?>css/cmxform.css">
  <!-- <script src="<?= base_url()?>js/lib/jquery.min.js" type="text/javascript"></script>-->
  <script src="<?= base_url()?>js/lib/jquery.hotkeys-0.7.9.min.js" type="text/javascript"></script>
  <script src="<?= base_url()?>js/lib/jquery.validate.min.js" type="text/javascript"></script>
<script>/*
